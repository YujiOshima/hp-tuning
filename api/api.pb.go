...
type SetEarlyStoppingParameterRequest struct {
	StudyId                  string                    `protobuf:"bytes,1,opt,name=study_id,json=studyId" json:"study_id,omitempty"`
	EarlyStopping_Parameters []*EarlyStoppingParameter `protobuf:"bytes,2,rep,name=early_stopping__parameters,json=earlyStoppingParameters" json:"early_stopping__parameters,omitempty"`
}
...
func (m *SetEarlyStoppingParameterRequest) GetEarlyStopping_Parameters() []*EarlyStoppingParameter {
	if m != nil {
		return m.EarlyStopping_Parameters
	}
	return nil
}
...
var fileDescriptor0 = []byte{
	...
	,
	...
	0x04, 0xf4, 0x48, 0x47, 0x75, 0xa1, 0x1a, 0xf9, 0x7b, 0xdf, 0xb1, 0xb4, 0xa0, 0x74, 0x8f, 0xcd,
	...
	0xb2, 0x31, 0x23, 0x36, 0xe5, 0xdf, 0xe8, 0x13, 0x28, 0x5b, 0xbe, 0x67, 0xa5, 0x70, 0x54, 0x3c,
	0xae, 0x9d, 0xed, 0x88, 0x18, 0x83, 0xd3, 0xf4, 0x70, 0x53, 0xfd, 0x35, 0xec, 0x0d, 0x66, 0xd3,
	0x29, 0xa1, 0xdc, 0xd9, 0xea, 0xec, 0xf3, 0xa3, 0xb9, 0x84, 0x83, 0x0e, 0xf6, 0xcc, 0xf9, 0x80,
	0x39, 0xae, 0x6b, 0xd8, 0xd3, 0x77, 0xf1, 0xf1, 0x0c, 0x8a, 0x43, 0x3c, 0xfd, 0x3f, 0x0c, 0x3e,
	0x87, 0x6a, 0xd7, 0x99, 0xd9, 0x8c, 0xe3, 0x86, 0xe3, 0xcd, 0xbd, 0x1f, 0x87, 0x08, 0x74, 0xef,
	0xc7, 0xdc, 0x91, 0x8b, 0xd9, 0x9b, 0xc0, 0x46, 0x7c, 0xab, 0x7f, 0x29, 0x40, 0x69, 0xe8, 0x19,
	...
	,
}
